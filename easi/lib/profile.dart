    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Text("${user?.displayName}", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 25),),
        ),
        Container(
          alignment: Alignment.center,
          padding: EdgeInsets.symmetric(vertical: 0, horizontal: 20),
          child: Text("${user?.email}", style: TextStyle(fontSize: 12, color: Colors.grey),),
        ),
        Container(
