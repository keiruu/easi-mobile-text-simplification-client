...
class WordsInPicture extends StatefulWidget {
  @override
  _WordsInPictureState createState() => _WordsInPictureState();
}

class _WordsInPictureState extends State<WordsInPicture> {
  var _selectedFile;
