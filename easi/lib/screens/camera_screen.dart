...
import 'package:easi/text_simplification.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:easi/screens/preview_screen.dart';
                                      ...
                                      InkWell(
                                        onTap: _isVideoCameraSelected
                                            ...
                                            : () async {
                                                ...
                                                _saveImage() async {
                                                  try {
                                                    bool? isImageSaved = await GallerySaver.saveImage('${directory.path}/$currentUnix.$fileFormat', albumName:"easi");
                                                  } catch (exception) {
                                                ...
                                                // After capturing the image it displays the image
                                                Navigator.of(context).push(
                                                  MaterialPageRoute(
                                                    builder: (context) =>
                                                        PreviewScreen(
