                  ...
                  children: <Widget>[
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.arrow_back_rounded, color: Color(0xFF5274AE), size: 36,),
                      ),
                    ),
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText: 'Enter text you want to understand better.'),
                      ),
                    ),
                    ...
                    Padding(
                        ...
                        child: TextButton(
                          style: ButtonStyle(
                            foregroundColor:
                                MaterialStateProperty.all<Color>(Color(0xFF5274AE)),
                            backgroundColor:
                                MaterialStateProperty.all<Color>(Color(0xFFCDDBF2)),
